...
CTEST_DRUID_DIR = os.path.join(APP_DIR, "druid")
...
MVN_TEST_PATH = {
    ...
    "processing": os.path.join(CTEST_DRUID_DIR, SRC_SUBDIR["druid"]),
}
...
LOCAL_CONF_PATH = {
    ...
    "processing": "results/processing/conf_params.txt",
}
...
CTEST_SUREFIRE_PATH = {
    ...
    "processing": [
        os.path.join(CTEST_DRUID_DIR, "processing", SUREFIRE_SUBDIR)
    ]
}
