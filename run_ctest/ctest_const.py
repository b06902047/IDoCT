...
SUREFIRE_DIR = {
    ...
    PROCESSING: [os.path.join(CTEST_DRUID_DIR, MODULE_SUBDIR[PROCESSING], SUREFIRE_SUBDIR)],
}
...
DEFAULT_CONF_FILE = {
    ...
    PROCESSING: os.path.join(DEFAULT_CONF_DIR, PROCESSING + "-default.tsv")
}
